...
public class ShopperStoreActivity extends AppCompatActivity {
        ...
        ref.orderByChild("storeId").equalTo(storeId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    Log.e("ShopperStoreActivity", "Database read error: No data found");
                }
            }
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                Log.e("ShopperStoreActivity", "Database read error: " + databaseError.getMessage());
            }
        });
    }
    ...
    public void editStoreInfo(View v) {
        ...
        query.child(storeId).child("name").setValue(storeName).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                setWarningText("");
                Toast.makeText(ShopperStoreActivity.this, getString(R.string.change_store_info_successful_text), Toast.LENGTH_LONG).show();
            }
        });
    }
